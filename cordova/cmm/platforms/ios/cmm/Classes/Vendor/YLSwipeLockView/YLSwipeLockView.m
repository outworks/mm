...
-(void)layoutSubviews{
    ...
    for (int i = 0; i < self.nodeArray.count; ++i) {
        ...
        CGFloat width = min / 5.5;
        CGFloat height = min / 5.5;
        int row = i % 3;
        int column = i / 3;
        CGRect frame = CGRectMake(row *(width * 2)+15, column * (width *2)+12, width, height);
...
-(void)cleanNodes
{
    ...
    self.polygonalLineLayer.strokeColor = [UIColor colorWithRed:0/255.f green:255./255.f blue:0/255.f alpha:0.3].CGColor;
    self.polygonalLineLayer.path = self.polygonalLinePath.CGPath;
}
...
-(void)makeNodesToWarning
{
    ...
    self.polygonalLineLayer.strokeColor = [UIColor colorWithRed:255/255.f green:0.f/255.f blue:0/255.f alpha:0.3].CGColor;
}
...
-(CAShapeLayer *)polygonalLineLayer
{
    if (_polygonalLineLayer == nil) {
        ...
        _polygonalLineLayer.lineWidth = 15.0f;
        _polygonalLineLayer.strokeColor = [UIColor colorWithRed:0/255.f green:255./255.f blue:0/255.f alpha:0.6].CGColor;
